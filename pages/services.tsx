  ...
  const servicesList = [
    {
      ...
      icon: "https://www.svgrepo.com/show/202992/web-design.svg",
      desc: t("services.webDesignDesc"),
      link: "/web-design",
    },
    {
      name: t("services.graphicDesignTitle"),
      icon: "https://www.svgrepo.com/show/256067/graphic-design-monitor.svg",
      desc: t("services.graphicDesignDesc"),
      link: "/graphic-design",
    },
    {
      name: t("services.seoTitle"),
      icon: "https://www.svgrepo.com/show/220473/seo.svg",
    ...
    },
    {
      ...
      icon: "https://www.svgrepo.com/show/428772/marketing-market-social.svg",
              ...
              {servicesList.map((service, idx) => (
                ...
                >
                  ...
                  <div className="pt-12 pb-2 flex flex-col items-center">
                    ...
                    <Link
                      href={service.link}
                      className="text-sm bg-cyan-500 dark:bg-cyan-300  p-3 rounded-4xl  font-semibold text-black group-hover:underline transition"
                    >
                      Learn More
                    </Link>
                  </div>
